...
Generated at 2026-09-02T21:25:43.570147+00:00
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/toml | 2,904 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/toml | 1 | 1.00 | 2,904 bytes #1 |
| C++/tomlplusplus | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/toml | 2,874 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/toml | 1 | 1.00 | 2,874 bytes #1 |
| C++/tomlplusplus | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/toml | 2,289 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/toml | 1 | 1.00 | 2,289 bytes #1 |
| C++/tomlplusplus | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/toml | 16,266 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/toml | 1 | 1.00 | 16,266 bytes #1 |
| C++/tomlplusplus | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/toml | 827 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/toml | 1 | 1.00 | 827 bytes #1 |
| C++/tomlplusplus | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/toml | 702 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/toml | 1 | 1.00 | 702 bytes #1 |
| C++/tomlplusplus | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/toml | 619 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/toml | 1 | 1.00 | 619 bytes #1 |
| C++/tomlplusplus | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/toml | 6,647 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/toml | 1 | 1.00 | 6,647 bytes #1 |
| C++/tomlplusplus | 0 | - | - |
...
| Output size | mesh | 100 | Rust/toml | 16,266 bytes |
| Gzip size | logs | 10 | Rust/toml | 827 bytes |
