...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/serde-yaml | 2,768 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/serde-yaml | 1 | 1.00 | 2,768 bytes #1 |
| C++/yaml-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/serde-yaml | 2,658 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/serde-yaml | 1 | 1.00 | 2,658 bytes #1 |
| C++/yaml-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/serde-yaml | 2,164 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/serde-yaml | 1 | 1.00 | 2,164 bytes #1 |
| C++/yaml-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/serde-yaml | 9,046 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/serde-yaml | 1 | 1.00 | 9,046 bytes #1 |
| C++/yaml-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/serde-yaml | 846 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/serde-yaml | 1 | 1.00 | 846 bytes #1 |
| C++/yaml-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/serde-yaml | 714 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/serde-yaml | 1 | 1.00 | 714 bytes #1 |
| C++/yaml-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/serde-yaml | 653 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/serde-yaml | 1 | 1.00 | 653 bytes #1 |
| C++/yaml-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/serde-yaml | 3,452 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/serde-yaml | 1 | 1.00 | 3,452 bytes #1 |
| C++/yaml-cpp | 0 | - | - |
...
| Output size | mesh | 100 | Rust/serde-yaml | 9,046 bytes |
| Gzip size | logs | 10 | Rust/serde-yaml | 846 bytes |
