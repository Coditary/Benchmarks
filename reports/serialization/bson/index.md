...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/bson | 0.0039 ms | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/bson | 1 | 1.00 | 0.0039 ms #1 |
| C++/nlohmann-bson | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/bson | 2,934 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/bson | 1 | 1.00 | 2,934 bytes #1 |
| C++/nlohmann-bson | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/bson | 2,802 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/bson | 1 | 1.00 | 2,802 bytes #1 |
| C++/nlohmann-bson | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/bson | 2,337 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/bson | 1 | 1.00 | 2,337 bytes #1 |
| C++/nlohmann-bson | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/bson | 9,075 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/bson | 1 | 1.00 | 9,075 bytes #1 |
| C++/nlohmann-bson | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/bson | 1,043 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/bson | 1 | 1.00 | 1,043 bytes #1 |
| C++/nlohmann-bson | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/bson | 892 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/bson | 1 | 1.00 | 892 bytes #1 |
| C++/nlohmann-bson | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/bson | 834 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/bson | 1 | 1.00 | 834 bytes #1 |
| C++/nlohmann-bson | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/bson | 4,174 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/bson | 1 | 1.00 | 4,174 bytes #1 |
| C++/nlohmann-bson | 0 | - | - |
...
| Output size | mesh | 100 | Rust/bson | 9,075 bytes |
| Gzip size | logs | 10 | Rust/bson | 1,043 bytes |
