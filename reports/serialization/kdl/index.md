...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/kdl | 2,630 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/kdl | 1 | 1.00 | 2,630 bytes #1 |
| C++/kdl-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/kdl | 2,758 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/kdl | 1 | 1.00 | 2,758 bytes #1 |
| C++/kdl-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/kdl | 2,324 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/kdl | 1 | 1.00 | 2,324 bytes #1 |
| C++/kdl-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/kdl | 10,914 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/kdl | 1 | 1.00 | 10,914 bytes #1 |
| C++/kdl-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/kdl | 821 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/kdl | 1 | 1.00 | 821 bytes #1 |
| C++/kdl-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/kdl | 726 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/kdl | 1 | 1.00 | 726 bytes #1 |
| C++/kdl-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/kdl | 639 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/kdl | 1 | 1.00 | 639 bytes #1 |
| C++/kdl-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/kdl | 3,414 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/kdl | 1 | 1.00 | 3,414 bytes #1 |
| C++/kdl-cpp | 0 | - | - |
...
| Output size | mesh | 100 | Rust/kdl | 10,914 bytes |
| Gzip size | logs | 10 | Rust/kdl | 821 bytes |
