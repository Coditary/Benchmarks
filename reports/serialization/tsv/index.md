...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/tsv | 1,562 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/tsv | 1 | 1.00 | 1,562 bytes #1 |
| C++/tsv-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/tsv | 1,279 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/tsv | 1 | 1.00 | 1,279 bytes #1 |
| C++/tsv-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/tsv | 1,249 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/tsv | 1 | 1.00 | 1,249 bytes #1 |
| C++/tsv-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/tsv | 5,545 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/tsv | 1 | 1.00 | 5,545 bytes #1 |
| C++/tsv-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/tsv | 656 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/tsv | 1 | 1.00 | 656 bytes #1 |
| C++/tsv-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/tsv | 518 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/tsv | 1 | 1.00 | 518 bytes #1 |
| C++/tsv-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/tsv | 478 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/tsv | 1 | 1.00 | 478 bytes #1 |
| C++/tsv-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/tsv | 2,675 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/tsv | 1 | 1.00 | 2,675 bytes #1 |
| C++/tsv-cpp | 0 | - | - |
...
| Output size | mesh | 100 | Rust/tsv | 5,545 bytes |
| Gzip size | logs | 10 | Rust/tsv | 656 bytes |
