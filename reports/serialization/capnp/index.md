...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/capnp | 2,240 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/capnp | 1 | 1.00 | 2,240 bytes #1 |
| C++/capnp-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/capnp | 2,488 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/capnp | 1 | 1.00 | 2,488 bytes #1 |
| C++/capnp-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/capnp | 2,728 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/capnp | 1 | 1.00 | 2,728 bytes #1 |
| C++/capnp-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/capnp | 2,904 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/capnp | 1 | 1.00 | 2,904 bytes #1 |
| C++/capnp-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/capnp | 1,012 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/capnp | 1 | 1.00 | 1,012 bytes #1 |
| C++/capnp-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/capnp | 987 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/capnp | 1 | 1.00 | 987 bytes #1 |
| C++/capnp-cpp | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/capnp | 2,509 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/capnp | 1 | 1.00 | 2,509 bytes #1 |
| C++/capnp-cpp | 0 | - | - |
...
| Output size | mesh | 100 | Rust/capnp | 2,904 bytes |
| Gzip size | logs | 10 | Rust/capnp | 1,012 bytes |
