...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/ucl | 2,703 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/ucl | 1 | 1.00 | 2,703 bytes #1 |
| C++/libucl | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/ucl | 2,840 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/ucl | 1 | 1.00 | 2,840 bytes #1 |
| C++/libucl | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/ucl | 2,393 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/ucl | 1 | 1.00 | 2,393 bytes #1 |
| C++/libucl | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/ucl | 9,919 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/ucl | 1 | 1.00 | 9,919 bytes #1 |
| C++/libucl | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/ucl | 863 bytes | — |

#### logs comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/ucl | 1 | 1.00 | 863 bytes #1 |
| C++/libucl | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/ucl | 748 bytes | — |

#### profile comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/ucl | 1 | 1.00 | 748 bytes #1 |
| C++/libucl | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/ucl | 681 bytes | — |

#### catalog comparison matrix

| Implementation | Wins | Avg rank | 10 |
| --- | ---: | ---: | ---: |
| Rust/ucl | 1 | 1.00 | 681 bytes #1 |
| C++/libucl | 0 | - | - |
...
| Rank | Implementation | Value | vs best |
| ---: | --- | ---: | ---: |
| 1 | Rust/ucl | 3,431 bytes | — |

#### mesh comparison matrix

| Implementation | Wins | Avg rank | 100 |
| --- | ---: | ---: | ---: |
| Rust/ucl | 1 | 1.00 | 3,431 bytes #1 |
| C++/libucl | 0 | - | - |
...
| Output size | mesh | 100 | Rust/ucl | 9,919 bytes |
| Gzip size | logs | 10 | Rust/ucl | 863 bytes |
